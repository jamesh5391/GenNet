...
print("\n--- Interpretation ---")
print("Current method: All P values have Var(G) = 1.0")
print("  → h² alone controls signal strength")
print("  → P only affects number of features, not signal strength")
print("\nProposed method: Var(G) decreases with P")
print("  → P=500 has 500× less genetic variance than P=1!")
print("  → This means for SAME h², P=500 is much harder to predict")
print("  → Matches biological reality!")
...
print("\n✅ **Primary Fix: Remove G_add standardization (Option 1)**")
print("   - Most realistic")
print("   - Preserves natural signal degradation with P")
print("   - Will show clear P effect: R² decreases as P increases")

print("\n✅ **Secondary Fix: Use within-gene epistasis**")
print("   - Already discussed")
print("   - Critical for testing epistasis")

print("\n⚠️  **Optional Enhancement: Effect size distribution (Option 2)**")
print("   - Makes it more realistic")
print("   - But not essential for showing P effect")
print("   - Can add in future experiments")

print("\n❌ **Don't Use: Sample size manipulation (Option 4)**")
print("   - Confounds P with sample size")
print("   - Hard to interpret")
print("   - Keep sample size constant")

print("\n" + "="*80)
print("IMPLEMENTATION CHECKLIST")
print("="*80)

print("\n1. [ ] Remove G_add_std = (G_add - mean) / std")
print("2. [ ] Replace with G_add_centered = G_add - mean")
print("3. [ ] Scale genetic component to match h²:")
print("       scale = sqrt(h² / var(G_add_centered))")
print("       genetic_component = scale * G_add_centered")
print("4. [ ] Keep environmental component: sqrt(1-h²) * noise")
print("5. [ ] DO NOT re-standardize final phenotype!")
print("6. [ ] Update within-gene epistasis (from previous analysis)")
print("7. [ ] Re-run diagnostics to verify:")
print("       - Var(phenotype) ≈ 1.0")
print("       - Var(genetic_component) = h²")
print("       - Var(G_add) decreases with P")
print("       - Corr(G_add, G_epi) < 0.7")
